...
@section("content")
  ...
  <div class="card-body">
		...
		<div class="col-md-6">
			...
			<div class="row-1 py-1">{!!Form::radio('role_id', '1');!!}
				{!!Form::label('rol', 'Administrador', ['class' => 'awesome']);!!}
			</div>
			<div class="row-1 py-1">{!!Form::radio('role_id', '2');!!}
				{!!Form::label('rol', 'Moderador', ['class' => 'awesome']);!!}
			</div>
			<div class="row-1 py-1">{!!Form::radio('role_id', '3');!!}
				{!!Form::label('rol', 'Usuario', ['class' => 'awesome']);!!}
			</div>			
